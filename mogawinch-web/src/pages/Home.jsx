  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Honest, down-to-earth video game reviews." />
      ...
      <main className="mx-auto max-w-6xl px-5 sm:px-8">
        <section className="pb-10 pt-12 sm:pt-20">
          ...
          <h1 className="font-heading max-w-3xl text-4xl font-semibold leading-[1.05] tracking-tight sm:text-6xl">
            Honest thoughts on the games I play.
          </h1>
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
            I write considered, spoiler-free reviews of the games I spend real time
            with, judged on the value they deliver for their price. I'm also building my own Pokémon
            romhack, Petalburg Dynasty.
          </p>
        </section>
